...
!function (e, t) {
    ...
    return function (e) {
        ...
        "use strict";
        var i = n(1), r = n(2), s = n(16), o = n(15), a = n(3);
        ...
        t.prettifyError = function (e, n, i) {
            ...
            if (null != e) if (n.each && e.each === n.each) e.forEach(t, i); else if (e.length === +e.length) for (var r = 0, s = e.length; r < s; r++) t.call(i, e[r], r, e)
        }, t.map = function (e, t) {
            var i = [];
            if (null == e) return i;
            ...
            var i = this.length >>> 0;
            for (n = +n || 0, Math.abs(n) === 1 / 0 && (n = 0), n < 0 && (n += i, n < 0 && (n = 0)); n < i; n++) if (e[n] === t) return n;
            return -1
        ...
        var r, s = n(3), o = n(4), a = n(1), l = n(6), c = n(7), h = n(14), u = n(15), p = n(13), f = n(18), m = n(19),
            d = p.Frame;
        ...
        r = l.extend({
            init: function (e, t, n, i) {
                ...
                var l = new g(e || {}, s.blocks, s.env), c = t ? t.push(!0) : new d;
                c.topLevel = !0;
                var h = null;
        ...
        (function (t) {
            ...
            function r(e) {
                var t = 1, n = new p(e), i = document.createTextNode("");
            ...
            e.exports = n;
            var o, a = [], l = !1, c = 0, h = 1024, u = "undefined" != typeof t ? t : self,
        ...
        var r = n(1), s = n(8), o = n(12), a = n(10), l = n(6), c = n(13).Frame,
            h = {"==": "==", "===": "===", "!=": "!=", "!==": "!==", "<": "<", ">": ">", "<=": "<=", ">=": ">="},
            u = l.extend({
                init: function (e, t) {
                ...
                compileCallExtension: function (e, t, n) {
                    var i = e.args, s = e.contentArgs, o = "boolean" != typeof e.autoescape || e.autoescape;
                ...
                _compileMacro: function (e, t) {
                    var n = [], i = null, s = "macro_" + this.tmpid(), o = void 0 !== t;
        ...
        var i = n(9), r = n(10), s = n(6), o = n(1), a = s.extend({
            init: function (e) {
                ...
                var n = this.parseExpression(), i = this.parseWithContext(),
                ...
                e = e || "raw";
                for (var t = "end" + e, n = new RegExp("([\\s\\S]*?){%\\s*(" + e + "|" + t + ")\\s*(?=%})%}"), i = 1, s = "", o = null, a = this.advanceAfterBlockEnd(); (o = this.tokens._extractRegex(n)) && i > 0;) {
                    var l = o[0], c = o[1], h = o[2];
        ...
        var s = n(1), o = " \n\t\r ", a = "()[]{}%*-+~/#,:|.<>=!", l = "0123456789", c = "{%", h = "%}", u = "{{",
            p = "}}", f = "{#", m = "#}", d = "string", v = "whitespace", g = "data", y = "block-start",
            k = "block-end", x = "variable-start", b = "variable-end", E = "comment", w = "left-paren",
            T = "right-paren", L = "left-bracket", _ = "right-bracket", O = "left-curly", A = "right-curly",
            S = "operator", N = "comma", C = "colon", B = "tilde", F = "pipe", I = "int", R = "float", K = "boolean",
            M = "none", P = "symbol", j = "special", D = "regex";
        r.prototype.nextToken = function () {
            ...
            if (e && n === -1 || !e && n !== -1) {
                var i = this.current();
                this.forward();
                for (var r = t.indexOf(this.current()); (e && r === -1 || !e && r !== -1) && !this.is_finished();) i += this.current(), this.forward(), r = t.indexOf(this.current());
                return i
            }
            return ""
        ...
        (function (t) {
            ...
            function r(e, n) {
                function i(e, n, i) {
                    for (var r = e.split("\n"), s = 0; s < r.length; s++) {
                        if (r[s] && (i && s > 0 || !i)) for (var o = 0; o < n; o++) t.stdout.write(" ");
            ...
            var s = n(1), o = n(6), a = o.extend("Node", {
                ...
                w = b.extend("AsyncAll"), T = a.extend("Macro", {fields: ["name", "args", "body"]}),
                L = T.extend("Caller"), _ = a.extend("Import", {fields: ["template", "target", "withContext"]}),
                ...
                I = a.extend("TemplateRef", {fields: ["template"]}), R = I.extend("Extends"),
                K = a.extend("Include", {fields: ["template", "ignoreMissing"]}),
                M = a.extend("Set", {fields: ["targets", "value"]}), P = c.extend("Output"),
                j = a.extend("Capture", {fields: ["body"]}), D = u.extend("TemplateData"),
                V = a.extend("UnaryOp", {fields: ["target"]}), U = a.extend("BinOp", {fields: ["left", "right"]}),
                W = U.extend("In"), G = U.extend("Or"), H = U.extend("And"), Y = V.extend("Not"), $ = U.extend("Add"),
                z = U.extend("Concat"), X = U.extend("Sub"), q = U.extend("Mul"), J = U.extend("Div"),
                Q = U.extend("FloorDiv"), Z = U.extend("Mod"), ee = U.extend("Pow"), te = V.extend("Neg"),
                ne = V.extend("Pos"), ie = a.extend("Compare", {fields: ["expr", "ops"]}),
        ...
        var r = n(1), s = n(13), o = {
            abs: Math.abs, batch: function (e, t, n) {
                ...
                if (s.length) {
                    if (n) for (i = s.length; i < t; i++) s.push(n);
                    r.push(s)
                }
                return r
        ...
        function r() {
            return {
                range: function (e, t, n) {
                    ...
                    var i, r = [];
                    if (n > 0) for (i = e; i < t; i += n) r.push(i); else for (i = e; i > t; i += n) r.push(i);
                    return r
                }, cycler: function () {
        ...
        (function (e, t) {
            !function (e, n) {
                ...
                if (!e.setImmediate) {
                    var f, m = 1, d = {}, v = !1, g = e.document, y = Object.getPrototypeOf && Object.getPrototypeOf(e);
        ...
        function n() {
            ...
            var i = this.runtime, r = this.lib, s = this.compiler.Compiler, o = this.parser.Parser, a = this.nodes,
                l = this.lexer, c = i.contextOrFrameLookup, h = s.prototype.assertType, u = o.prototype.parseAggregate,
                p = i.memberLookup;
            ...
            var f = a.Node.extend("Slice", {
                fields: ["start", "stop", "step"], init: function (e, t, n, i, r) {
            ...
            s.prototype.assertType = function (e) {
                ...
                try {
                    ...
                    var i = t(this.tokens), s = function () {
